...
public class ListProjectDevelopersCommand implements Command {
    @Override
    public void process(HttpServletRequest req, HttpServletResponse resp, TemplateEngine engine) throws IOException {
        try {
            ...
            parameterMap.put("question", "Developers list of the project " + projectName + " :");
            parameterMap.put("lines", ProjectDaoService.getInstance(DBConnection.getInstance().getConnection())
                    .getListDevelopers(projectName));
